...
public class JImGui {
    ...
    public static void drawVec2Control (String label, Vector2f values, float resetValue, float columnWidth){
        ...
        ImGui.pushStyleColor(ImGuiCol.ButtonHovered, 0.4f, 0.9f, 0.4f, 1.0f);
        ...
        ImGui.pushStyleColor(ImGuiCol.Button, 0.8f, 0.1f, 0.2f, 1.0f);
        ImGui.pushStyleColor(ImGuiCol.ButtonHovered, 0.95f, 0.3f, 0.4f, 1.0f);
        ImGui.pushStyleColor(ImGuiCol.ButtonActive, 0.8f, 0.1f, 0.2f, 1.0f);
        ImGui.pushItemWidth(widthEach);
    ...
    public static boolean colourPicker4 (String label, Vector4f colour){
        boolean res = false;
        ImGui.pushID(label);
        ...
        if(ImGui.colorEdit4("##colorPicker", imColour)){
