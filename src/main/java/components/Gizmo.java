...
public class Gizmo extends Component{
    private Vector4f xAxisColour = new Vector4f(1,0.3f,0.3f,1);
    private Vector4f xAxisColourHover = new Vector4f(1,0,0,1);
    private Vector4f yAxisColour = new Vector4f(0.3f,1,0.3f,1);
    ...
    public void start() {
        ...
        this.xAxisObject.setNoSerializer();
        this.yAxisObject.setNoSerializer();
    }
    @Override
    ...
    private void setActive() {
        this.xAxisSprite.setColor(xAxisColour);
        this.yAxisSprite.setColor(yAxisColour);
    }
    ...
    private boolean checkXHoverState(){
        ...
        if(mousePos.x <= xAxisObject.transform.position.x && mousePos.x >= xAxisObject.transform.position.x - gizmoHeight &&
            ...
            xAxisSprite.setColor(xAxisColourHover);
            return true;
        }

        xAxisSprite.setColor(xAxisColour);
        return false;
    }
    ...
    private boolean checkYHoverState(){
        ...
        if(mousePos.x <= yAxisObject.transform.position.x && mousePos.x >= yAxisObject.transform.position.x - gizmoWidth &&
            ...
            yAxisSprite.setColor(yAxisColourHover);
            return true;
        }

        yAxisSprite.setColor(yAxisColour);
        return false;
    }
